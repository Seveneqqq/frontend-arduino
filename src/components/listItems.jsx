    ...
    return (
        <ul className="flex flex-row justify-between h-full w-full gap-6 items-center z-3">
            ...
            {!singIn ? (<Dialog
                ...
                content={({ hide }) => (
                    <div className="flex flex-col px-8 py-5 gap-4" style={{ borderRadius: '12px', backgroundImage: 'radial-gradient(circle at left top, var(--primary-400), var(--primary-700))' }}>
