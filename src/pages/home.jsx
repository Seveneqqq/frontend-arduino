                    ...
                    <div className='flex flex-col md:flex-row w-full'>
                        <div className="w-full flex flex-col gap-6">
                            ...
                            <div className="flex gap-4 opacity-0 -translate-x-4 animate-slideRight animation-delay-700">
                                <a href="https://github.com/Seveneqqq" target="_blank" className="p-3 rounded-full bg-blue-900/20 text-white hover:bg-blue-800/30 transition-all">
                                    <i className="pi pi-github" style={{ fontSize: '1.25rem' }}></i>
                                </a>
                                <a href="https://www.linkedin.com/in/seveneqqq" target="_blank" className="p-3 rounded-full bg-blue-900/20 text-white hover:bg-blue-800/30 transition-all">
